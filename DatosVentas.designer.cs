...
namespace Práctica_6
{
	...
	public partial class DatosVentasDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertFactura(FacturaC instance);
    partial void UpdateFactura(FacturaC instance);
    partial void DeleteFactura(FacturaC instance);
    ...
    partial void DeleteProducto(Producto instance);
		...
		public DatosVentasDataContext() : 
				base(global::Práctica_6.Properties.Settings.Default.bd_ventasConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public DatosVentasDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DatosVentasDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DatosVentasDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DatosVentasDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<FacturaC> Factura
		{
			get
			{
				return this.GetTable<FacturaC>();
			}
		}
	...
	public partial class FacturaC : INotifyPropertyChanging, INotifyPropertyChanged
	{
	...
	public partial class Producto : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<FacturaC> _Factura;
    ...
    partial void OnFk_CodigoChanged();
		...
		public Producto()
		{
			this._Factura = default(EntityRef<FacturaC>);
			OnCreated();
		}
		...
		public FacturaC Factura
		{
			...
			set
			{
				FacturaC previousValue = this._Factura.Entity;
